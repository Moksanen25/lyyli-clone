...
export default function FeaturesAccordionLayout({
  ...
  const features = [
    // Automatic Content Creation
    {
      category: "automatic",
      icon: (
        <div className="w-12 h-12 bg-gradient-to-br from-forest to-turquoise rounded-2xl flex items-center justify-center flex-shrink-0">
    ...
    // Governance & Compliance
    {
      category: "governance",
      icon: (
        <div className="w-12 h-12 bg-gradient-to-br from-turquoise to-forest rounded-2xl flex items-center justify-center flex-shrink-0">
          <svg className="w-6 h-6 text-white" fill="none" stroke="currentColor" viewBox="0 0 24 24">
    ...
    // Enterprise Security
    {
      category: "security",
      icon: (
        <div className="w-12 h-12 bg-gradient-to-br from-rose to-turquoise rounded-2xl flex items-center justify-center flex-shrink-0">
          <svg className="w-6 h-6 text-white" fill="none" stroke="currentColor" viewBox="0 0 24 24">
    ...
    // Multilingual Support
    {
      ...
      icon: (
        <div className="w-12 h-12 bg-gradient-to-br from-turquoise to-rose rounded-2xl flex items-center justify-center flex-shrink-0">
          <svg className="w-6 h-6 text-white" fill="none" stroke="currentColor" viewBox="0 0 24 24">
    ...
    // System Integrations
    {
      ...
      icon: (
        <div className="w-12 h-12 bg-gradient-to-br from-forest to-rose rounded-2xl flex items-center justify-center flex-shrink-0">
          <svg className="w-6 h-6 text-white" fill="currentColor" viewBox="0 0 24 24">
            <path d="M6.194 14.644c0 1.293.857 2.43 2.164 2.43 1.301 0 2.168-1.137 2.168-2.43 0-1.293-.867-2.43-2.168-2.43-1.307 0-2.164 1.137-2.164 2.43zm2.164-9.644c-1.307 0-2.164 1.142-2.164 2.43 0 1.293.857 2.43 2.164 2.43 1.301 0 2.168-1.137 2.168-2.43 0-1.288-.867-2.43-2.168-2.43zm5.636 0c-1.307 0-2.164 1.142-2.164 2.43 0 1.293.857 2.43 2.164 2.43 1.301 0 2.168-1.137 2.168-2.43 0-1.288-.867-2.43-2.168-2.43zm2.164 9.644c0-1.288-.867-2.43-2.168-2.43-1.307 0-2.164 1.142-2.164 2.43 0 1.293.857 2.43 2.164 2.43 1.301 0 2.168-1.137 2.168-2.43z"/>
          </svg>
        </div>
    ...
    <div className="space-y-4">
      {features.map((feature, index) => (
        <div key={index} className="bg-white rounded-2xl border border-gray-200 shadow-lg overflow-hidden">
          <button
            className="w-full px-6 py-6 text-left flex items-center justify-between hover:bg-rose/5 transition-all duration-300 focus:outline-none focus:ring-2 focus:ring-forest/20"
          ...
          >
            ...
            <svg
              className={`w-5 h-5 text-forest transform transition-transform duration-300 ${
          ...
          >
            <div className="px-6 pb-6 pt-2">
              <div className="bg-gradient-to-br from-rose/5 to-turquoise/5 rounded-xl p-6">
