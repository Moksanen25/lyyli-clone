...
export function ThemeToggle() {
  const { theme, setTheme, resolvedTheme, resetToLight } = useTheme();
    ...
    <div className="flex items-center gap-2">
      ...
      {resolvedTheme === 'dark' && (
        <button
          ...
          className="px-3 py-2 text-xs bg-forest text-white rounded-lg hover:bg-forest/90 transition-colors duration-200"
