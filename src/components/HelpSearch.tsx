          ...
          {isSearching ? (
            ...
            <div>
              {results.length > 0 ? (
                  ...
                  {results.map((article, index) => (
                    ...
                    >
                      <div className="flex items-start gap-3">
                        ...
                        <svg className="w-5 h-5 text-mediumGray dark:text-gray-400 flex-shrink-0 mt-1" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                ...
                <div className="p-4 text-center text-mediumGray dark:text-gray-500">
                  <svg className="mx-auto h-12 w-12 text-mediumGray dark:text-gray-400 mb-2" fill="none" viewBox="0 0 24 24" stroke="currentColor">
                  ...
                  {recentSearches.map((searchTerm, index) => (
                    ...
                    >
                      <div className="flex items-center gap-3">
                        <svg className="w-4 h-4 text-mediumGray dark:text-gray-400" fill="none" stroke="currentColor" viewBox="0 0 24 24">
