...
export default function ComplianceBadges({ locale, translations: t }: ComplianceBadgesProps) {
  const badges = [
    {
      name: "GDPR",
    ...
    <div className="text-center">
      ...
      <div className="grid md:grid-cols-2 lg:grid-cols-4 gap-6">
        {badges.map((item, index) => (
          <div
            key={index}
            className="text-center p-4 bg-white rounded-lg border border-grayLight hover:border-turquoise transition-all duration-300 hover:shadow-medium"
          >
      ...
      <p className="mt-8 text-sm text-mediumGray max-w-2xl mx-auto font-sans leading-relaxed">
        {locale === "en"
