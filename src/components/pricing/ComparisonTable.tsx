...
export default function ComparisonTable({
  ...
  const comparisonData: ComparisonRow[] = [
    ...
    // Features
    {
      feature: t['pricing.features.section.features'],
      free: '',
      launch: '',
      growth: '',
      professional: '',
    ...
    {
      feature: t['pricing.features.basicTone'],
      free: true,
      launch: true,
      growth: true,
      professional: true,
    ...
    {
      feature: t['pricing.features.advancedTone'],
      free: false,
      launch: false,
      growth: true,
      professional: true,
    ...
    {
      feature: t['pricing.features.editorMode'],
      free: false,
      launch: false,
      growth: false,
      professional: true,
    ...
    {
      feature: t['pricing.features.orgManagementRoles'],
      free: false,
      launch: false,
      growth: true,
      professional: true,
    ...
    {
      feature: t['pricing.features.slackOrTeams'],
      free: false,
      launch: false,
      growth: true,
      professional: true,
    ...
    {
      feature: t['pricing.features.advancedAIAnalytics'],
      free: false,
      launch: false,
      growth: false,
      professional: true,
    ...
    {
      feature: t['pricing.features.campaignMode'],
      free: false,
      launch: false,
      growth: false,
      professional: true,
    ...
    {
      feature: t['pricing.features.mediaLibrary'],
      free: false,
      launch: false,
      growth: false,
      professional: true,
    ...
    {
      feature: t['pricing.features.kpiReports'],
      free: false,
      launch: false,
      growth: false,
      professional: true,
    ...
    {
      feature: t['pricing.features.brandedTemplates'],
      free: false,
      launch: false,
      growth: false,
      professional: true,
    ...
    {
      feature: t['pricing.features.guidedOnboarding'],
      free: '199€',
      launch: '199€',
      growth: t['pricing.features.guidedOnboardingFreeAnnual'],
      professional: t['pricing.features.included'],
      enterprise: t['pricing.custom'],
    },
    {
      feature: t['pricing.features.formalSLA'],
      free: false,
      launch: false,
      growth: false,
      professional: true,
    ...
    {
      feature: t['pricing.features.namedAccountManager'],
      free: false,
      launch: false,
      growth: false,
      professional: false,
    ...
    {
      feature: t['pricing.features.localEntity'],
      free: false,
      launch: false,
      growth: false,
      professional: false,
    ...
    // Help & Support
    {
      feature: t['pricing.features.section.support'],
      free: '',
      launch: '',
      growth: '',
      professional: '',
    ...
    {
      feature: t['pricing.features.helpLibrary'],
      free: true,
      launch: true,
      growth: true,
      professional: true,
    ...
    {
      feature: t['pricing.features.emailSupport'],
      free: false,
      launch: true,
      growth: true,
      professional: true,
    ...
    {
      feature: t['pricing.features.firstResponseTarget'],
      free: '1-2 days',
      launch: '1-2 days',
      growth: t['pricing.features.sameDay'],
      professional: '4 hours (9-15)',
      enterprise: '4 hours (9-15)',
    },
    {
      feature: t['pricing.features.serviceAvailability'],
      free: t['pricing.features.bestEffort'],
      launch: t['pricing.features.bestEffort'],
      growth: '99.5%',
      professional: '99.9%',
      enterprise: '99.9%',
    },
    ...
    // Access & Security
    {
      feature: t['pricing.features.section.accessSecurity'],
      free: '',
      launch: '',
      growth: '',
      professional: '',
    ...
    {
      feature: t['pricing.features.sso'],
      free: false,
      launch: false,
      growth: true,
      professional: true,
    ...
    {
      feature: t['pricing.features.mfa'],
      free: false,
      launch: false,
      growth: true,
      professional: true,
    ...
    {
      feature: t['pricing.features.scim'],
      free: false,
      launch: false,
      growth: false,
      professional: true,
    ...
    {
      feature: t['pricing.features.slo'],
      free: false,
      launch: false,
      growth: false,
      professional: false,
    ...
    {
      feature: t['pricing.features.euDataResidencyDpa'],
      free: false,
      launch: false,
      growth: false,
      professional: true,
    ...
    {
      feature: t['pricing.features.allIntegrationsIncluded'],
      free: false,
      launch: false,
      growth: false,
      professional: false,
    ...
    {
      feature: t['pricing.features.webhooks'],
      free: false,
      launch: false,
      growth: false,
      professional: true,
    ...
    {
      feature: t['pricing.features.auditLogsRetention'],
      free: '-',
      launch: '30 days',
      growth: '180 days',
    ...
    {
      feature: t['pricing.features.apiScope'],
      free: t['pricing.features.none'],
      launch: t['pricing.features.none'],
      growth: t['pricing.features.coreAPIs'],
      professional: t['pricing.features.fullAPIsWebhooks'],
      enterprise: t['pricing.features.fullAPIsWebhooks'],
    },
  ];
    ...
    <div className="space-y-8">
      ...
      <div className="text-center">
        ...
        <p className="text-sm text-mediumGray font-sans">
          {(t['pricing.pricingNote'] as string).replace(
            '{period}',
            t['pricing.monthly']
          )}
        </p>
        <p className="text-sm text-mediumGray font-sans mt-1">
          {t['pricing.vatNote']}
        </p>
