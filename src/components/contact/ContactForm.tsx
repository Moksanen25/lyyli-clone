...
export default function ContactForm({ locale }: ContactFormProps) {
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    alert(locale === 'fi' ? 'Kiitos! Otamme yhteyttä pian.' : 'Thank you! We\'ll be in touch soon.');
  };
      ...
      <form onSubmit={handleSubmit} className="space-y-6">
        ...
        <div>
          ...
          <input
            ...
            required
            className="w-full px-4 py-3 border border-light-gray rounded-lg focus:ring-2 focus:ring-forest-green focus:border-forest-green transition-colors"
          />
        </div>
        ...
        <div className="grid md:grid-cols-2 gap-6">
          ...
          <div>
            <label htmlFor="role" className="block text-sm font-medium text-dark-gray mb-2">
        ...
        {/* Team Size Field */}
        <div>
          <label htmlFor="teamSize" className="block text-sm font-medium text-dark-gray mb-2">
          ...
          >
            ...
            <option value="100-500">{t['contact.form.teamsize.option3']}</option>
        ...
        <div>
          ...
          <textarea
            ...
            rows={4}
            className="w-full px-4 py-3 border border-light-gray rounded-lg focus:ring-2 focus:ring-forest-green focus:border-forest-green transition-colors resize-vertical"
          />
        </div>
        ...
        <button
          ...
          className="w-full bg-forest-green text-white py-4 px-8 rounded-lg hover:bg-opacity-90 transition-colors font-medium disabled:opacity-50 disabled:cursor-not-allowed inline-flex items-center justify-center gap-2"
        >
          {isSubmitting ? (
            <>
