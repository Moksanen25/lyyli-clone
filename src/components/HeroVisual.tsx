  ...
  return (
    <div className="absolute inset-0 overflow-hidden pointer-events-none">
      ...
      <div className="absolute inset-0">
        ...
        {/* AI Brain Icon with Glow - Fixed colors for dark mode */}
        <div className="absolute top-28 left-1/2 transform -translate-x-1/2">
          <div className="relative">
            <div className="w-12 h-12 sm:w-16 sm:h-16 bg-gradient-to-br from-green-600/10 sm:from-green-600/20 to-blue-300/10 sm:to-blue-300/20 dark:from-white/20 dark:to-white/10 rounded-full flex items-center justify-center backdrop-blur-sm border border-green-600/5 sm:border-green-600/10 dark:border-white/20 animate-pulse">
              <svg className="w-6 h-6 sm:w-8 sm:h-8 text-green-600 dark:text-white" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={1.5} d="M9.663 17h4.673M12 3v1m6.364 1.636l-.707.707M21 12h-1M4 12H3m3.343-5.657l-.707-.707m2.828 9.9a5 5 0 117.072 0l-.548.547A3.374 3.374 0 0014 18.469V19a2 2 0 11-4 0v-.531c0-.895-.356-1.754-.988-2.386l-.548-.547z" />
              </svg>
            </div>
            {/* Glow Effect - Fixed colors for dark mode */}
            <div className="absolute inset-0 w-12 h-12 sm:w-16 sm:h-16 bg-gradient-to-br from-green-600/15 sm:from-green-600/30 to-blue-300/15 sm:to-blue-300/30 dark:from-white/20 dark:to-white/10 rounded-full blur-lg sm:blur-xl animate-pulse" 
                 style={{ animationDuration: '3s' }} />
          </div>
        </div>
        
        {/* Floating Message Bubbles - Fixed colors for dark mode */}
        <div className="hidden sm:block absolute top-16 left-20 transform -rotate-12">
          <div className="bg-white/80 dark:bg-white/20 backdrop-blur-sm rounded-2xl px-3 py-2 shadow-lg border border-green-600/10 dark:border-white/20 animate-bounce" 
               style={{ animationDelay: '0.5s', animationDuration: '2.5s' }}>
            <div className="text-xs text-green-600 dark:text-white font-medium">AI</div>
          </div>
        </div>
        
        <div className="hidden sm:block absolute top-20 right-24 transform rotate-12">
          <div className="bg-white/80 dark:bg-white/20 backdrop-blur-sm rounded-2xl px-3 py-2 shadow-lg border border-blue-300/10 dark:border-white/20 animate-bounce" 
               style={{ animationDelay: '1s', animationDuration: '3s' }}>
            <div className="text-xs text-blue-600 dark:text-white font-medium">Team</div>
          </div>
        </div>
        
        {/* Subtle Grid Pattern - Fixed colors for dark mode */}
        ...
        <div 
          className="hidden sm:block absolute w-32 h-32 bg-gradient-to-br from-green-600/5 to-blue-300/5 dark:from-white/5 dark:to-white/5 rounded-full blur-2xl transition-all duration-300 ease-out pointer-events-none"
          style={{
