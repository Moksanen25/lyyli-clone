...
export default async function AccessControl({ locale }: AccessControlProps) {
  ...
  const accessFeatures = [
    {
      title: t['cybersecurity.accessControl.sections.control.roleBasedAccess.title'],
      description: t['cybersecurity.accessControl.sections.control.roleBasedAccess.description'],
      icon: (
    ...
    {
      title: t['cybersecurity.accessControl.sections.control.administratorControl.title'],
      description: t['cybersecurity.accessControl.sections.control.administratorControl.description'],
      icon: (
        <svg className="w-8 h-8 text-forest" fill="none" stroke="currentColor" viewBox="0 0 24 24">
    ...
    {
      title: t['cybersecurity.accessControl.sections.control.activityLogging.title'],
      description: t['cybersecurity.accessControl.sections.control.activityLogging.description'],
      icon: (
        <svg className="w-8 h-8 text-forest" fill="none" stroke="currentColor" viewBox="0 0 24 24">
    ...
    {
      title: t['cybersecurity.accessControl.sections.control.automaticMonitoring.title'],
      description: t['cybersecurity.accessControl.sections.control.automaticMonitoring.description'],
      icon: (
        <svg className="w-8 h-8 text-forest" fill="none" stroke="currentColor" viewBox="0 0 24 24">
        ...
        <div className="grid lg:grid-cols-2 gap-12 items-center">
          <div>
            <h3 className="text-2xl font-playfair font-bold text-forest mb-8">
              {t['cybersecurity.accessControl.sections.control.title']}
            </h3>
