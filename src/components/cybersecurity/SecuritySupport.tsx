...
export default async function SecuritySupport({ locale }: SecuritySupportProps) {
  ...
  const supportChannels = [
    ...
    },
    {
      ...
      icon: (
        <svg className="w-8 h-8 text-forest" fill="none" stroke="currentColor" viewBox="0 0 24 24">
          <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M8 10h.01M12 10h.01M16 10h.01M9 16H5a2 2 0 01-2-2V6a2 2 0 012-2h14a2 2 0 012 2v8a2 2 0 01-2 2h-5l-5 4z" />
        </svg>
      ),
    },
    {
  ...
  return (
    <div>
          ...
          <div key={index} className="bg-white rounded-2xl p-8 shadow-lg border border-gray-200 hover:shadow-xl transition-all duration-300 hover:-translate-y-1 text-center">
            ...
            {channel.address ? (
              <a
                ...
                className="inline-flex items-center justify-center px-6 py-3 bg-forest text-white font-semibold rounded-2xl shadow-lg hover:shadow-xl transition-all duration-300 hover:-translate-y-1"
              >
                {channel.address}
              </a>
            ) : (
              <button className="inline-flex items-center justify-center px-6 py-3 bg-forest text-white font-semibold rounded-2xl shadow-lg hover:shadow-xl transition-all duration-300 hover:-translate-y-1">
                {channel.button}
              </button>
            )}
          </div>
      ...
      <div className="bg-white rounded-2xl p-8 shadow-lg border border-gray-200 hover:shadow-xl transition-all duration-300 text-center max-w-4xl mx-auto">
        <div className="w-20 h-20 bg-forest/20 rounded-2xl flex items-center justify-center mx-auto mb-6">
        ...
        <a
          href={`/${locale}/contact`}
          className="inline-flex items-center justify-center px-8 py-4 bg-turquoise text-white font-semibold rounded-2xl shadow-lg hover:shadow-xl transition-all duration-300 hover:-translate-y-1"
        >
