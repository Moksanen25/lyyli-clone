  ...
  const popularPages = [
    {
      ...
      description:
        t['notFound.popularPages.home.description'] || 'Return to our homepage',
      href: `/${locale}`,
    ...
    },
    {
      ...
      description:
        t['notFound.popularPages.features.description'] ||
    ...
    },
    {
      ...
      description:
        t['notFound.popularPages.security.description'] ||
    ...
    },
    {
      ...
      description:
        t['notFound.popularPages.blog.description'] ||
      ...
      >
        ...
        <div className="text-center bg-white/60 backdrop-blur-sm rounded-2xl p-8 md:p-10 max-w-3xl mx-auto shadow-md border border-turquoise/20">
          <p className="text-darkGray mb-6 text-base md:text-lg font-medium">
            {t['notFound.additionalHelp.title'] ||
