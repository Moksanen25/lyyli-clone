                  ...
                  <div className="w-12 h-12 bg-forest/10 rounded-lg flex items-center justify-center mb-4 group-hover:bg-forest/20 transition-colors">
                    ...
                    >
                      <path
                        ...
                        strokeLinejoin="round"
                        strokeWidth={2}
                        d="M17 20h5v-2a4 4 0 00-3-3.87M9 20H4v-2a4 4 0 013-3.87m6 1.87a4 4 0 10-8 0 4 4 0 008 0z"
                      />
                    </svg>
                  </div>
                  <h3 className="text-lg text-forest mb-2 group-hover:text-forest transition-colors font-playfair font-normal">
              ...
              <Link href={`/${locale}/help/prompt-library`} className="group">
                <div className="bg-gradient-to-br from-forest/5 to-turquoise/5 p-6 rounded-lg border-2 border-turquoise hover:border-forest hover:shadow-lg transition-all duration-200">
                  ...
                  <div className="flex items-center gap-2 mb-2">
                    <h3 className="text-lg text-forest group-hover:text-forest transition-colors font-playfair font-normal">
                      {locale === 'fi' ? 'Prompt-kirjasto' : 'Prompt Library'}
                    </h3>
                    <span className="inline-flex items-center px-2 py-0.5 rounded text-xs font-medium bg-turquoise text-white">
                      {locale === 'fi' ? 'Uusi' : 'New'}
                    </span>
                  </div>
                  <p className="text-mediumGray font-sans leading-relaxed">
                    {locale === 'fi'
                      ? 'Valmiit prompt-esimerkit tehokkaaseen viestintään'
                      : 'Ready-made prompt examples for effective communication'}
                  </p>
                </div>
              </Link>
                  ...
                  <div className="w-12 h-12 bg-forest/10 rounded-lg flex items-center justify-center mb-4 group-hover:bg-forest/20 transition-colors">
                    ...
                    >
                      <path
                        ...
                        strokeLinejoin="round"
                        strokeWidth={2}
                        d="M8 16h8M8 12h8m-7 8h6a2 2 0 002-2V6a2 2 0 00-2-2H9l-3 3v13a2 2 0 002 2z"
                      />
                    </svg>
                  </div>
                  <h3 className="text-lg text-forest mb-2 group-hover:text-forest transition-colors font-playfair font-normal">
