...
export const metadata: Metadata = {
  ...
  description:
    'Create organizations, manage invites, roles, permissions, teams, and audit trails in Lyyli.ai.',
};
              ...
              <li>
                <div className="flex items-center">
                  ...
                  <span className="ml-4 text-sm font-medium text-gray-500">
                    {locale === 'fi'
                      ? 'Organisaatiot ja käyttäjähallinta'
        ...
        <div className="max-w-7xl mx-auto px-6 py-16">
          <div className="max-w-3xl">
            ...
            <p className="text-xl text-[#333333] font-inter leading-relaxed">
              {locale === 'fi'
                ? 'Luo ja hallitse organisaatiorakenteita, kutsu tiimin jäseniä ja määritä roolit. Hallitse käyttöoikeuksia ja seuraa käyttäjien toimintaa.'
                : 'Create and manage organizational structures, invite team members, and define roles. Manage access rights and track user activity.'}
            </p>
          </div>
        </div>
      </div>
          ...
          <div className="p-8">
            <section className="mb-8">
              <h2 className="text-2xl font-semibold text-gray-900 mb-2">
                {locale === 'fi'
                  ? 'Organisaation luominen ja omistajuus'
                  : 'Organization creation and ownership'}
              </h2>
              <ul className="list-disc list-inside text-gray-700 space-y-1 ml-4">
                <li>
                  {locale === 'fi'
                    ? 'Perusta uusi organisaatio ja määritä omistaja'
                    : 'Create a new organization and set owner'}
                </li>
                <li>
                  {locale === 'fi'
                    ? 'Siirrä omistajuus tarvittaessa'
            ...
            <section className="mb-8">
              <h2 className="text-2xl font-semibold text-gray-900 mb-2">
                {locale === 'fi'
                  ? 'Kutsut, roolit, käyttöoikeusmalli'
                  : 'Invites, roles, permission model'}
              </h2>
              <p className="text-gray-700 mb-2">
                {locale === 'fi'
                  ? 'Kutsu käyttäjiä sähköpostilla, määritä roolit ja oikeudet.'
                  : 'Invite users by email, assign roles and permissions.'}
              </p>
              <div className="grid grid-cols-1 md:grid-cols-3 gap-4">
                ...
                <div className="bg-gray-50 p-4 rounded-md">
                  ...
                  <p className="text-sm text-gray-700">
                    {locale === 'fi'
                      ? 'Tiimit, sisällöt, raportit'
                      : 'Teams, content, reports'}
                  </p>
                </div>
                <div className="bg-gray-50 p-4 rounded-md">
                  <h3 className="font-medium text-gray-900 mb-1">
                  ...
                  <p className="text-sm text-gray-700">
                    {locale === 'fi'
                      ? 'Perusoikeudet, omat työt'
                      : 'Basic rights, own work'}
                  </p>
                </div>
              </div>
            </section>
            ...
            <section className="mb-8">
              <h2 className="text-2xl font-semibold text-gray-900 mb-2">
                {locale === 'fi'
                  ? 'Tiimit/ryhmät ja oikeuksien periytyminen'
                  : 'Teams/groups and permission inheritance'}
              </h2>
              <ul className="list-disc list-inside text-gray-700 space-y-1 ml-4">
                <li>
                  {locale === 'fi'
                    ? 'Peri oikeuksia organisaatiosta tiimeihin'
                    : 'Inherit permissions from org to teams'}
                </li>
                <li>
                  {locale === 'fi'
                    ? 'Yliaja tiimitasolla tarvittaessa'
                    : 'Override at team level when needed'}
                </li>
              </ul>
            </section>
            ...
            <section>
              ...
              <p className="text-gray-700">
                {locale === 'fi'
                  ? 'Tarkastele tapahtumalokia ja suodata toiminnoittain, käyttäjittäin ja ajanjaksoittain.'
                  : 'Review event logs filtered by actions, users, and time windows.'}
              </p>
            </section>
          </div>
