...
export const metadata: Metadata = {
  ...
  description:
    'Learn how to manage team members, set permissions, and control access to your Lyyli.ai workspace for effective collaboration.',
};
        ...
        <div className="max-w-7xl mx-auto px-6 py-16">
          <div className="max-w-3xl">
            ...
            <h1 className="text-4xl md:text-5xl font-bold text-[#2F5D50] mb-6 font-playfair leading-tight">
              {locale === 'fi' ? 'Käyttäjähallinta' : 'User management'}
            </h1>
            <p className="text-xl text-[#333333] font-inter leading-relaxed">
              {locale === 'fi'
                ? 'Hallitse käyttäjätilejä, määritä roolit ja oikeudet sekä seuraa käyttäjien toimintaa. Luo tehokkaita työnkulkuja tiimillesi.'
                : 'Manage user accounts, define roles and permissions, and track user activity. Create efficient workflows for your team.'}
            </p>
          </div>
        </div>
      </div>
                ...
                <div className="border border-gray-200 rounded-lg p-6">
                  ...
                  <div className="bg-gray-50 p-4 rounded-md mb-4">
                    ...
                    <ol className="list-decimal list-inside space-y-1 text-sm text-gray-700">
                      <li>
                        {locale === 'fi'
                          ? 'Mene tiimiasetuksiin'
                          : 'Go to Team Settings'}
                      </li>
                      <li>
                        {locale === 'fi'
                          ? "Klikkaa 'Lisää käyttäjä'"
                          : "Click 'Add User'"}
                      </li>
                      <li>
                        {locale === 'fi'
                      ...
                      <li>
                        {locale === 'fi' ? 'Valitse rooli' : 'Select role'}
                      </li>
                      <li>
                        {locale === 'fi' ? 'Lähetä kutsu' : 'Send invitation'}
                      </li>
                    </ol>
                  </div>
                ...
                <div className="border border-gray-200 rounded-lg p-6">
                  ...
                  <div className="bg-gray-50 p-4 rounded-md mb-4">
                    ...
                    <ul className="space-y-1 text-sm text-gray-700">
                      <li>
                        • {locale === 'fi' ? 'Käyttäjän rooli' : 'User role'}
                      </li>
                      <li>
                        •{' '}
                        {locale === 'fi'
                          ? 'Projektikohtaiset oikeudet'
                          : 'Project-specific permissions'}
                      </li>
                      <li>
                        •{' '}
                        {locale === 'fi'
                          ? 'Pääsy tietyihin ominaisuuksiin'
                ...
                <div className="border border-gray-200 rounded-lg p-6">
                  ...
                  <div className="bg-gray-50 p-4 rounded-md mb-4">
                    ...
                    <ol className="list-decimal list-inside space-y-1 text-sm text-gray-700">
                      <li>
                        {locale === 'fi'
                          ? 'Mene käyttäjän profiliin'
                          : 'Go to user profile'}
                      </li>
                      <li>
                        {locale === 'fi'
                          ? "Klikkaa 'Poista käyttäjä'"
                          : "Click 'Remove User'"}
                      </li>
                      <li>
                        {locale === 'fi'
                ...
                <div className="bg-green-50 p-6 rounded-lg border border-green-200">
                  ...
                  <ul className="space-y-2 text-sm text-green-800">
                    ...
                    <li>
                      •{' '}
                      {locale === 'fi'
                        ? 'Kirjaudu ulos yhteisistä laitteista'
                ...
                <div className="bg-red-50 p-6 rounded-lg border border-red-200">
                  ...
                  <ul className="space-y-2 text-sm text-red-800">
                    ...
                    <li>
                      •{' '}
                      {locale === 'fi'
                        ? 'Vanhojen käyttäjien jättäminen'
