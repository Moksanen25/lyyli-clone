...
export const metadata: Metadata = {
  ...
  description:
    'Learn how to manage, train, and optimize your AI communications assistants for better performance and brand consistency.',
};
        ...
        <div className="max-w-7xl mx-auto px-6 py-16">
          <div className="max-w-3xl">
            ...
            <p className="text-xl text-[#333333] font-inter leading-relaxed">
              {locale === 'fi'
                ? 'Hallitse useita tekoälyavustajia, kouluta niitä ja optimoi niiden suorituskyky. Luo erikoistuneita avustajia eri tarkoituksiin ja varmista brändiyhtenäisyys kaikessa viestinnässä.'
                : 'Manage multiple AI assistants, train them, and optimize their performance. Create specialized assistants for different purposes and ensure brand consistency across all communications.'}
            </p>
          </div>
        </div>
      </div>
            ...
            <div className="mb-8">
              ...
              <div className="mb-6">
                ...
                <ul className="list-disc list-inside text-gray-600 space-y-1 ml-4">
                  <li>
                    {locale === 'fi'
                      ? 'Uusimmat tuotetiedot ja päivitykset'
                      : 'Latest product information and updates'}
                  </li>
                  <li>
                    {locale === 'fi'
                      ? 'Asiakaskysymykset ja vastaukset'
                      : 'Customer questions and responses'}
                  </li>
                  <li>
                    {locale === 'fi'
                      ? 'Yrityspolitiikat ja prosessit'
                      : 'Company policies and processes'}
                  </li>
                  <li>
                    {locale === 'fi'
                      ? 'Markkinointimateriaalit ja kampanjat'
              ...
              <div className="mb-6">
                <h3 className="text-xl font-semibold text-gray-900 mb-3">
                  {locale === 'fi'
                    ? '2. Vastauksien arviointi ja parantaminen'
                    : '2. Evaluating and improving responses'}
                </h3>
                <p className="text-gray-600 mb-3">
                  {locale === 'fi'
                ...
                <ul className="list-disc list-inside text-gray-600 space-y-1 ml-4">
                  <li>
                    {locale === 'fi'
                      ? 'Käyttäjien palaute ja arvostelut'
                      : 'User feedback and ratings'}
                  </li>
                  <li>
                    {locale === 'fi'
                      ? 'Vastauksen tarkkuus ja hyödyllisyys'
                      : 'Response accuracy and helpfulness'}
                  </li>
                  <li>
                    {locale === 'fi'
                      ? 'Brändiyhtenäisyyden tarkistus'
