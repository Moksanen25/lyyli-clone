...
export const metadata: Metadata = {
  ...
  description:
    'Learn how to export your data, create backups, and understand GDPR compliance for your Lyyli.ai workspace.',
};
        ...
        <div className="max-w-7xl mx-auto px-6 py-16">
          <div className="max-w-3xl">
            ...
            <h1 className="text-4xl md:text-5xl font-bold text-[#2F5D50] mb-6 font-playfair leading-tight">
              {locale === 'fi' ? 'Tiedonhallinta' : 'Data management'}
            </h1>
                ...
                <div className="border border-gray-200 rounded-lg p-6">
                  ...
                  <div className="bg-gray-50 p-4 rounded-md mb-4">
                    ...
                    <ol className="list-decimal list-inside space-y-1 text-sm text-gray-700">
                      ...
                      <li>
                        {locale === 'fi'
                          ? "Valitse 'Tietojen vienti'"
                          : "Select 'Data Export'"}
                      </li>
                      <li>
                        {locale === 'fi'
                          ? 'Valitse vientityyppi'
                          : 'Choose export type'}
                      </li>
                      <li>
                        {locale === 'fi'
                  ...
                  <div className="bg-gray-50 p-4 rounded-md">
                    ...
                    <ul className="space-y-1 text-sm text-gray-700">
                      ...
                      <li>
                        •{' '}
                        {locale === 'fi'
                          ? 'Tärkeiden projektien jälkeen'
                          : 'After important projects'}
                      </li>
                      <li>
                        •{' '}
                        {locale === 'fi'
                          ? 'Säännöllisesti (esim. kuukausittain)'
                  ...
                  <div className="bg-gray-50 p-4 rounded-md">
                    ...
                    <ul className="space-y-1 text-sm text-gray-700">
                      <li>
                        •{' '}
                        {locale === 'fi'
                          ? 'Käyttäjätiedot (nimi, sähköposti)'
                      ...
                      <li>
                        •{' '}
                        {locale === 'fi' ? 'Tekniset lokit' : 'Technical logs'}
                      </li>
                    </ul>
                  </div>
                  ...
                  <div>
                    ...
                    <ul className="space-y-2 text-sm text-gray-700">
                      <li>
                        •{' '}
                        {locale === 'fi'
                          ? 'Tietoja säilytetään koko tilausajan'
                          : 'Data retained for subscription duration'}
                      </li>
                      <li>
                        •{' '}
                        {locale === 'fi'
