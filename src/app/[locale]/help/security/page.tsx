...
export const metadata: Metadata = {
  ...
  description:
    'Learn about Lyyli.ai security features, GDPR compliance, data protection, and best practices for keeping your information safe.',
};
        ...
        <div className="max-w-7xl mx-auto px-6 py-16">
          <div className="max-w-3xl">
            ...
            <p className="text-xl text-[#333333] font-inter leading-relaxed">
              {locale === 'fi'
                ? 'Tutustu Lyylin tietoturvakäytäntöihin, tietosuojaan ja vaatimustenmukaisuuteen. Ymmärrä, miten suojaamme datasi ja yksityisyytesi.'
                : "Learn about Lyyli's security practices, data privacy, and compliance. Understand how we protect your data and privacy."}
            </p>
          </div>
        </div>
      </div>
            ...
            <div className="mb-8">
                ...
                <div className="grid grid-cols-1 md:grid-cols-3 gap-4 mb-4">
                  ...
                  <div className="bg-green-50 rounded-lg p-4">
                    ...
                    <ul className="text-sm text-green-700 space-y-1">
                      <li>
                        •{' '}
                        {locale === 'fi' ? 'Perustoiminnot' : 'Basic functions'}
                      </li>
                      <li>
                        •{' '}
                        {locale === 'fi' ? 'Omat avustajat' : 'Own assistants'}
                      </li>
                      <li>
                        •{' '}
                        {locale === 'fi'
              ...
              <div className="mb-6">
                ...
                <ul className="list-disc list-inside text-gray-600 space-y-1 ml-4">
                  <li>
                    {locale === 'fi'
                      ? 'SMS-viestit tai autentikaattorisovellukset'
                      : 'SMS messages or authenticator apps'}
                  </li>
                  <li>
                    {locale === 'fi'
                      ? 'Pakollinen kaikille admin-käyttäjille'
                      : 'Required for all admin users'}
                  </li>
                  <li>
                    {locale === 'fi'
                      ? 'Varmuuskoodien varmistus'
                      : 'Backup code verification'}
                  </li>
                  <li>
                    {locale === 'fi'
                      ? 'Automaattinen lukitus epäilyttävän toiminnan jälkeen'
