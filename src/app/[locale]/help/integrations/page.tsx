...
export const metadata: Metadata = {
  ...
  description:
    'Learn how to integrate Lyyli.ai with your website, CRM, help desk, and other business tools for seamless AI communications.',
};
        ...
        <div className="max-w-7xl mx-auto px-6 py-16">
          <div className="max-w-3xl">
            ...
            <p className="text-xl text-[#333333] font-inter leading-relaxed">
              {locale === 'fi'
                ? 'Yhdistä Lyyli muihin työkaluihisi ja palveluihisi. Tutustu käytettävissä oleviin integraatioihin ja opi, miten automatisoit työnkulkujasi.'
                : 'Connect Lyyli with your other tools and services. Explore available integrations and learn how to automate your workflows.'}
            </p>
          </div>
        </div>
      </div>
              ...
              <div className="bg-gray-100 border-2 border-dashed border-gray-300 rounded-lg p-8 text-center mb-4">
                ...
                >
                  <path
                    ...
                    strokeWidth={2}
                    d="M21 12a9 9 0 01-9 9m9-9a9 9 0 00-9-9m9 9H3m9 9v-9m0-9v9m0-9H3"
                  />
                </svg>
            ...
            <div className="mb-8">
              ...
              <div className="mb-6">
                ...
                <ul className="list-disc list-inside text-gray-600 space-y-1 ml-4">
                  ...
                  <li>
                    {locale === 'fi'
                      ? 'Määritä käyttöoikeudet ja rajoitukset'
                      : 'Set permissions and limitations'}
                  </li>
                  <li>
                    {locale === 'fi'
                      ? 'Kopioi avain turvalliseen paikkaan'
