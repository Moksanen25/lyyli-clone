        ...
        <div className="max-w-7xl mx-auto px-6 py-16">
          <div className="max-w-3xl">
            ...
            <h1 className="text-4xl md:text-5xl font-bold text-[#2F5D50] mb-6 font-playfair leading-tight">
              {locale === 'fi'
                ? 'Rekisteröityminen ja tilaus'
                : 'Registration and subscription'}
            </h1>
            <p className="text-xl text-[#333333] font-inter leading-relaxed">
              {locale === 'fi'
                ? 'Aloita Lyylin käyttö rekisteröitymällä, valitse sopiva tilaus ja aktivoi tilisi. Tutustu eri tilauspaketteihin ja niiden ominaisuuksiin.'
                : 'Start using Lyyli by registering, choose the right subscription, and activate your account. Explore different subscription packages and their features.'}
            </p>
          </div>
        </div>
      </div>
              ...
              <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
                <div className="bg-gray-50 p-6 rounded-lg border border-gray-200">
                  ...
                  <ul className="space-y-2 text-gray-700 text-sm">
                    ...
                    <li>
                      •{' '}
                      {locale === 'fi' ? '1 tekoälyavustaja' : '1 AI assistant'}
                    </li>
                    <li>
                      •{' '}
                      {locale === 'fi'
                        ? '100 viestiä/kuukausi'
                        : '100 messages/month'}
                    </li>
                    <li>
                      •{' '}
                ...
                <div className="bg-purple-50 p-6 rounded-lg border border-purple-200">
                  ...
                  <ul className="space-y-2 text-purple-800 text-sm">
                    <li>
                      •{' '}
                      {locale === 'fi'
                        ? 'Rajoittamaton käyttäjä'
                        : 'Unlimited users'}
                    </li>
                    <li>
                      •{' '}
                      {locale === 'fi'
                        ? 'Rajoittamaton avustaja'
                        : 'Unlimited assistants'}
                    </li>
                    <li>
                      •{' '}
                      {locale === 'fi'
                        ? 'Rajoittamaton viesti'
                        : 'Unlimited messages'}
                    </li>
                    <li>
                      •{' '}
                    ...
                    <li>
                      • {locale === 'fi' ? 'SLA-sopimus' : 'SLA agreement'}
                    </li>
                    <li>
                      •{' '}
                      {locale === 'fi'
                ...
                <div className="bg-blue-50 p-6 rounded-lg border border-blue-200">
                  ...
                  <ul className="space-y-2 text-blue-800">
                    <li>
                      •{' '}
                      {locale === 'fi'
                        ? 'Kuinka monta käyttäjää tarvitset?'
                        : 'How many users do you need?'}
                    </li>
                    <li>
                      •{' '}
                      {locale === 'fi'
                        ? 'Kuinka monta tekoälyavustajaa?'
                        : 'How many AI assistants?'}
                    </li>
                    <li>
                      •{' '}
                      {locale === 'fi'
                        ? 'Kuinka paljon viestejä kuukaudessa?'
                        : 'How many messages per month?'}
                    </li>
                    <li>
                      •{' '}
                      {locale === 'fi'
                        ? 'Tarvitsetko erityisiä integraatioita?'
                        : 'Do you need special integrations?'}
                    </li>
                    <li>
                      •{' '}
                      {locale === 'fi'
                ...
                <div className="bg-gray-50 p-6 rounded-lg">
                  ...
                  <ul className="space-y-2 text-gray-700">
                    ...
                    <li>
                      •{' '}
                      {locale === 'fi'
                        ? 'Turvallinen Stripe-maksupalvelu'
              ...
              <div className="bg-yellow-50 p-6 rounded-lg border border-yellow-200">
                ...
                <ul className="space-y-2 text-yellow-800">
                  ...
                  <li>
                    •{' '}
                    {locale === 'fi'
                      ? 'Tukitiimi auttaa käyttöönotossa'
                      : 'Support team helps with implementation'}
                  </li>
                </ul>
              </div>
            </section>
