...
export const metadata: Metadata = {
  ...
  description:
    'Contact our support team for help with Lyyli.ai. Multiple support channels available including email, chat, and phone.',
};
        ...
        <div className="max-w-7xl mx-auto px-6 py-16">
          <div className="max-w-3xl">
            ...
            <p className="text-xl text-[#333333] font-inter leading-relaxed">
              {locale === 'fi'
                ? 'Tarvitsetko apua? Ota yhteyttä tukitiimiimme sähköpostitse, chatin kautta tai ajanvarauskalenterimme kautta. Olemme täällä auttamassa sinua.'
                : "Need help? Contact our support team via email, chat, or through our booking calendar. We're here to help you."}
            </p>
          </div>
        </div>
      </div>
            ...
            <div className="w-16 h-16 bg-forest/10 rounded-full flex items-center justify-center mx-auto mb-6">
              ...
              >
                <path
                  ...
                  strokeLinejoin="round"
                  strokeWidth={2}
                  d="M8 10h.01M12 10h.01M16 10h.01M9 16H5a2 2 0 01-2-2V6a2 2 0 012-2h14a2 2 0 012 2v8a2 2 0 01-2 2h-5l-5 4z"
                />
              </svg>
            </div>
            <h3 className="text-xl font-semibold text-gray-900 mb-4">
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
              <div>
                ...
                <input
                  ...
                  placeholder={
                    locale === 'fi' ? 'Koko nimesi' : 'Your full name'
                  }
                />
              </div>
