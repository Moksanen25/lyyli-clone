        ...
        <article className="bg-white rounded-xl shadow-sm border border-[#E5E5E4] overflow-hidden">
          ...
          <div className="p-8">
            ...
            <section className="mb-8">
              ...
              <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                <Link href={`/${locale}/help/target-audience`} className="group focus:outline-none focus:ring-2 focus:ring-[#2F5D50] focus:ring-offset-2 rounded-xl">
                ...
                <Link href={`/${locale}/help/getting-started`} className="group focus:outline-none focus:ring-2 focus:ring-[#2F5D50] focus:ring-offset-2 rounded-xl">
                  <div className="p-6 border border-[#E5E5E4] rounded-xl hover:border-[#2F5D50] hover:bg-[#F7EBEB] transition-all duration-200">
                    <h3 className="font-bold text-[#333333] group-hover:text-[#2F5D50] mb-2 font-playfair">
          ...
          <div className="px-8 py-6 bg-[#F5F5F4] border-t border-[#E5E5E4]">
            <div className="flex items-center justify-between text-sm text-[#666666] font-inter">
              ...
              <div className="flex items-center space-x-4">
                <Link href={`/${locale}/help`} className="text-[#2F5D50] hover:text-[#3A6A5C] transition-colors duration-200 focus:outline-none focus:ring-2 focus:ring-[#2F5D50] focus:ring-offset-2 rounded">
