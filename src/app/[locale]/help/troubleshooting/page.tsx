...
export const metadata: Metadata = {
  ...
  description:
    'Find solutions to common problems and issues when using Lyyli.ai. Step-by-step troubleshooting guides for various scenarios.',
};
        ...
        <article className="bg-white rounded-lg shadow-sm border border-gray-200 overflow-hidden">
          ...
          <div className="p-8">
              ...
              <div className="bg-blue-50 border border-blue-200 rounded-lg p-6 mb-6">
                ...
                <ul className="space-y-2 text-blue-800">
                  <li className="flex items-start">
                    <svg
                      className="flex-shrink-0 h-4 w-4 text-blue-600 mt-0.5 mr-2"
                      fill="currentColor"
                      viewBox="0 0 20 20"
                    >
                      <path
                  ...
                  <li className="flex items-start">
                    ...
                    {locale === 'fi'
                      ? 'Onko kirjautumistietosi oikein?'
                  ...
                  <li className="flex items-start">
                    ...
                    {locale === 'fi'
                      ? 'Onko palvelun tila normaali?'
                      : 'Is the service status normal?'}
                  </li>
                </ul>
              </div>
              ...
              <div className="mb-6">
                ...
                <div className="bg-green-50 border border-green-200 rounded-lg p-4 mb-3">
                  ...
                  <ol className="list-decimal list-inside text-green-800 space-y-1">
                    ...
                    <li>
                      {locale === 'fi'
                        ? 'Tarkista URL-osoite (https://app.lyyli.ai)'
                        : 'Check URL (https://app.lyyli.ai)'}
                    </li>
                    <li>
                      {locale === 'fi'
                        ? 'Käytä salasanan palautusta tarvittaessa'
              ...
              <div className="mb-6">
                ...
                <div className="bg-green-50 border border-green-200 rounded-lg p-4 mb-3">
                  ...
                  <ol className="list-decimal list-inside text-green-800 space-y-1">
                    <li>
                      {locale === 'fi'
                        ? 'Tarkista avustajan tietopohja ja koulutus'
                        : "Check assistant's knowledge base and training"}
                    </li>
                    <li>
                      {locale === 'fi'
                        ? 'Varmista että avustaja on aktiivinen'
                        : 'Ensure assistant is active'}
                    </li>
                    <li>
                      {locale === 'fi'
                        ? 'Tarkista brändiasetukset ja persoonallisuus'
                        : 'Check brand settings and personality'}
                    </li>
                    <li>
                      {locale === 'fi'
                        ? 'Kouluta avustaja uudelleen tarvittaessa'
                        : 'Retrain assistant if needed'}
                    </li>
                  </ol>
                </div>
              </div>
              ...
              <div className="mb-6">
                ...
                <div className="bg-green-50 border border-green-200 rounded-lg p-4 mb-3">
                  ...
                  <ol className="list-decimal list-inside text-green-800 space-y-1">
                    <li>
                      {locale === 'fi'
                        ? 'Tarkista JavaScript-koodin asennus'
                        : 'Check JavaScript code installation'}
                    </li>
                    <li>
                      {locale === 'fi'
                        ? 'Varmista API-avaimen oikeellisuus'
                        : 'Verify API key correctness'}
                    </li>
                    <li>
                      {locale === 'fi'
                        ? 'Tarkista verkkosivuston SSL-sertifikaatti'
                        : 'Check website SSL certificate'}
                    </li>
                    <li>
                      {locale === 'fi'
                        ? 'Testaa integraatiota eri selaimilla'
              ...
              <div className="mb-6">
                ...
                <div className="bg-green-50 border border-green-200 rounded-lg p-4 mb-3">
                  ...
                  <ol className="list-decimal list-inside text-green-800 space-y-1">
                    ...
                    <li>
                      {locale === 'fi'
                        ? 'Sulje tarpeettomat välilehdet ja sovellukset'
                        : 'Close unnecessary tabs and applications'}
                    </li>
                    <li>
                      {locale === 'fi'
                        ? 'Tarkista palvelun tila ja kuormitus'
                        : 'Check service status and load'}
                    </li>
                  </ol>
                </div>
              </div>
            ...
            <div className="mb-8">
              <h2 className="text-2xl font-semibold text-gray-900 mb-4">
                {locale === 'fi'
                  ? 'Edistyneet vianmääritysmenetelmät'
              ...
              <div className="grid grid-cols-1 md:grid-cols-2 gap-4 mb-6">
                <div className="bg-gray-50 rounded-lg p-4">
                  ...
                  <ul className="text-sm text-gray-600 space-y-1">
                    <li>
                      • {locale === 'fi' ? 'Päivitä selain' : 'Update browser'}
                    </li>
                    <li>
                      •{' '}
                      {locale === 'fi'
                    ...
                    <li>
                      •{' '}
                      {locale === 'fi' ? 'Tyhjennä välimuisti' : 'Clear cache'}
                    </li>
                  </ul>
                </div>
                <div className="bg-gray-50 rounded-lg p-4">
                  ...
                  <ul className="text-sm text-gray-600 space-y-1">
                    ...
                    <li>
                      • {locale === 'fi' ? 'Poista lisäosat' : 'Remove add-ons'}
                    </li>
                    <li>
                      • {locale === 'fi' ? 'Käytä safe modea' : 'Use safe mode'}
                    </li>
                  </ul>
                </div>
                <div className="bg-gray-50 rounded-lg p-4">
                  ...
                  <ul className="text-sm text-gray-600 space-y-1">
                    <li>
                      • {locale === 'fi' ? 'Päivitä macOS' : 'Update macOS'}
                    </li>
                    <li>
                      •{' '}
                      {locale === 'fi' ? 'Tyhjennä välimuisti' : 'Clear cache'}
                    ...
                    <li>
                      • {locale === 'fi' ? 'Poista evästeet' : 'Remove cookies'}
                    </li>
                  </ul>
                </div>
                <div className="bg-gray-50 rounded-lg p-4">
                  ...
                  <ul className="text-sm text-gray-600 space-y-1">
                    <li>
                      • {locale === 'fi' ? 'Päivitä sovellus' : 'Update app'}
                    </li>
                    <li>
                      •{' '}
                      {locale === 'fi'
              ...
              <div className="grid grid-cols-1 md:grid-cols-2 gap-4 mb-6">
                <div className="bg-red-50 rounded-lg p-4">
                  ...
                  <ul className="text-sm text-red-700 space-y-1">
                    ...
                    <li>
                      • {locale === 'fi' ? 'Tietojen menetys' : 'Data loss'}
                    </li>
                    <li>
                      •{' '}
                      {locale === 'fi'
                ...
                <div className="bg-yellow-50 rounded-lg p-4">
                  ...
                  <ul className="text-sm text-yellow-700 space-y-1">
                    <li>
                      •{' '}
                      {locale === 'fi'
                        ? 'Ongelma jatkuu yli 24h'
                        : 'Issue persists over 24h'}
                    </li>
                    <li>
                      •{' '}
                      {locale === 'fi'
                        ? 'Vianmääritys ei auta'
                        : "Troubleshooting doesn't help"}
                    </li>
                    <li>
                      •{' '}
                      {locale === 'fi'
                        ? 'Useita käyttäjiä vaikutettu'
