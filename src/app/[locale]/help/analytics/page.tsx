...
export const metadata: Metadata = {
  ...
  description:
    'Learn how to use Lyyli.ai analytics to track performance, understand user behavior, and optimize your AI communications strategy.',
};
            ...
            <ol className="flex items-center space-x-4">
              ...
              <li>
                <div className="flex items-center">
                  <svg
                    className="flex-shrink-0 h-5 w-5 text-mediumGray"
                    fill="currentColor"
                    viewBox="0 0 20 20"
                  >
                    <path
        ...
        <div className="max-w-7xl mx-auto px-6 py-16">
          <div className="max-w-3xl">
            ...
            <p className="text-xl text-[#333333] font-inter leading-relaxed">
              {locale === 'fi'
                ? 'Seuraa viestintäsi tehokkuutta, analysoi käyttötrendejä ja tee datapohjaisia päätöksiä. Hyödynnä kattavat raportit ja visualisaatiot paremman ymmärryksen saavuttamiseksi.'
                : 'Track your communication effectiveness, analyze usage trends, and make data-driven decisions. Leverage comprehensive reports and visualizations for better insights.'}
            </p>
          </div>
        </div>
      </div>
          ...
          <div className="p-8">
            ...
            <div className="mb-8">
              ...
              <div className="bg-gray-100 border-2 border-dashed border-gray-300 rounded-lg p-8 text-center mb-4">
                <svg
                  className="mx-auto h-12 w-12 text-mediumGray"
                  fill="none"
                  viewBox="0 0 24 24"
                  stroke="currentColor"
                >
            ...
            <div className="mb-8">
              ...
              <div className="mb-6">
                ...
                <ul className="list-disc list-inside text-gray-600 space-y-1 ml-4">
                  <li>
                    {locale === 'fi'
                      ? 'Käyttäjätytyväisyyden kehitys'
                      : 'User satisfaction trends'}
                  </li>
                  <li>
                    {locale === 'fi'
                      ? 'Vastausajan muutokset'
                      : 'Response time changes'}
                  </li>
                  <li>
                    {locale === 'fi'
                      ? 'Käyttöasteen vaihtelut'
              ...
              <div className="mb-6">
                ...
                <ul className="list-disc list-inside text-gray-600 space-y-1 ml-4">
                  <li>
                    {locale === 'fi'
                      ? 'Avustajien välinen vertailu'
                      : 'Inter-assistant comparison'}
                  </li>
                  <li>
                    {locale === 'fi'
                      ? 'Aiempaan suorituskykyyn verrattuna'
                      : 'Comparison to previous performance'}
                  </li>
                  <li>
                    {locale === 'fi'
                      ? 'Kohderyhmäkohtaiset mittarit'
                      : 'Target audience-specific metrics'}
                  </li>
                  <li>
                    {locale === 'fi'
                      ? 'Kilpailijoiden vertailu (jos saatavilla)'
