...
export const metadata: Metadata = {
  ...
  description: "Tutustu Lyyli.ai:n kohderyhmiin ja eri käyttötarkoituksiin yrityksissä.",
};
      ...
      <div className="max-w-4xl mx-auto px-6 py-12">
        <article className="bg-white rounded-xl shadow-sm border border-[#E5E5E4] overflow-hidden">
          ...
          <div className="p-8">
              ...
              <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                <div className="bg-[#F7EBEB] p-6 rounded-xl border border-[#E5E5E4]">
                  <h3 className="text-lg font-bold text-[#2F5D50] mb-4 font-playfair">
                    {locale === "fi" ? "Pienet ja keskisuuret yritykset" : "Small and Medium Businesses"}
                  </h3>
                  <ul className="space-y-3 text-[#333333] font-inter">
                    <li className="flex items-start">
                      ...
                      <span>{locale === "fi" ? "10-500 työntekijää" : "10-500 employees"}</span>
                    </li>
                    <li className="flex items-start">
                      <svg className="flex-shrink-0 h-5 w-5 text-[#2F5D50] mt-0.5 mr-3" fill="currentColor" viewBox="0 0 20 20">
                        <path fillRule="evenodd" d="M16.707 5.293a1 1 0 010 1.414l-8 8a1 1 0 01-1.414 0l-4-4a1 1 0 011.414-1.414L8 12.586l7.293-7.293a1 1 0 011.414 0z" clipRule="evenodd" />
                      </svg>
                      <span>{locale === "fi" ? "Kasvava viestintätarve" : "Growing communication needs"}</span>
                    </li>
                    <li className="flex items-start">
                      <svg className="flex-shrink-0 h-5 w-5 text-[#2F5D50] mt-0.5 mr-3" fill="currentColor" viewBox="0 0 20 20">
                        <path fillRule="evenodd" d="M16.707 5.293a1 1 0 010 1.414l-8 8a1 1 0 01-1.414 0l-4-4a1 1 0 011.414-1.414L8 12.586l7.293-7.293a1 1 0 011.414 0z" clipRule="evenodd" />
                      </svg>
                      <span>{locale === "fi" ? "Rajoitetut resurssit" : "Limited resources"}</span>
                    </li>
                  </ul>
                </div>
                <div className="bg-green-50 p-6 rounded-lg border border-green-200">
                  ...
                  <ul className="space-y-2 text-green-800">
                    <li className="flex items-start">
                      <svg className="flex-shrink-0 h-5 w-5 text-green-600 mt-0.5 mr-3" fill="currentColor" viewBox="0 0 20 20">
                        <path fillRule="evenodd" d="M16.707 5.293a1 1 0 010 1.414l-8 8a1 1 0 01-1.414 0l-4-4a1 1 0 011.414-1.414L8 12.586l7.293-7.293a1 1 0 011.414 0z" clipRule="evenodd" />
                      </svg>
                      <span>{locale === "fi" ? "500+ työntekijää" : "500+ employees"}</span>
                    </li>
                    <li className="flex items-start">
                      <svg className="flex-shrink-0 h-5 w-5 text-green-600 mt-0.5 mr-3" fill="currentColor" viewBox="0 0 20 20">
                        <path fillRule="evenodd" d="M16.707 5.293a1 1 0 010 1.414l-8 8a1 1 0 01-1.414 0l-4-4a1 1 0 011.414-1.414L8 12.586l7.293-7.293a1 1 0 011.414 0z" clipRule="evenodd" />
                      </svg>
                      <span>{locale === "fi" ? "Monimutkainen viestintä" : "Complex communication"}</span>
                    </li>
                    <li className="flex items-start">
                      <svg className="flex-shrink-0 h-5 w-5 text-green-600 mt-0.5 mr-3" fill="currentColor" viewBox="0 0 20 20">
                        <path fillRule="evenodd" d="M16.707 5.293a1 1 0 010 1.414l-8 8a1 1 0 01-1.414 0l-4-4a1 1 0 011.414-1.414L8 12.586l7.293-7.293a1 1 0 011.414 0z" clipRule="evenodd" />
                      </svg>
                      <span>{locale === "fi" ? "Korkeat turvallisuusvaatimukset" : "High security requirements"}</span>
                    </li>
                  </ul>
                </div>
              </div>
              ...
              <div className="space-y-6">
                <div className="border-l-4 border-blue-500 pl-6">
                  <h3 className="text-lg font-semibold text-gray-900 mb-2">
                    {locale === "fi" ? "Markkinointi ja myynti" : "Marketing and Sales"}
                  </h3>
                  ...
                  <ul className="text-sm text-gray-600 space-y-1">
                    ...
                    <li>• {locale === "fi" ? "Myyntimateriaalit" : "Sales materials"}</li>
                    <li>• {locale === "fi" ? "Proposaalit ja tarjoukset" : "Proposals and quotes"}</li>
                  </ul>
                </div>
              ...
              <div className="grid grid-cols-1 md:grid-cols-3 gap-4">
                <div className="bg-gray-50 p-4 rounded-lg text-center">
                  ...
                  <p className="text-sm text-gray-600">
                    {locale === "fi" ? "SaaS-yritykset, IT-palvelut" : "SaaS companies, IT services"}
                  </p>
                </div>
                <div className="bg-gray-50 p-4 rounded-lg text-center">
                  <h3 className="font-semibold text-gray-900 mb-2">
                  ...
                  <p className="text-sm text-gray-600">
                    {locale === "fi" ? "Liikkeenjohdon konsultointi" : "Management consulting"}
                  </p>
                </div>
                <div className="bg-gray-50 p-4 rounded-lg text-center">
                  <h3 className="font-semibold text-gray-900 mb-2">
                  ...
                  <p className="text-sm text-gray-600">
                    {locale === "fi" ? "Asiakaspalvelu, markkinointi" : "Customer service, marketing"}
                  </p>
                </div>
                <div className="bg-gray-50 p-4 rounded-lg text-center">
                  <h3 className="font-semibold text-gray-900 mb-2">
                  ...
                  <p className="text-sm text-gray-600">
                    {locale === "fi" ? "Koulutuspalvelut, e-learning" : "Educational services, e-learning"}
                  </p>
                </div>
                <div className="bg-gray-50 p-4 rounded-lg text-center">
                  <h3 className="font-semibold text-gray-900 mb-2">
                  ...
                  <p className="text-sm text-gray-600">
                    {locale === "fi" ? "Potilaskommunikaatio" : "Patient communication"}
                  </p>
                </div>
                <div className="bg-gray-50 p-4 rounded-lg text-center">
                  <h3 className="font-semibold text-gray-900 mb-2">
                  ...
                  <p className="text-sm text-gray-600">
                    {locale === "fi" ? "Pankit, vakuutusyhtiöt" : "Banks, insurance companies"}
                  </p>
                </div>
              </div>
            </section>
            ...
            <section className="mb-8">
              <h2 className="text-2xl font-bold text-[#2F5D50] mb-4 font-playfair leading-tight">
                {locale === "fi" ? "Käyttöönottovaatimukset" : "Implementation Requirements"}
              </h2>
              <div className="bg-yellow-50 p-6 rounded-lg border border-yellow-200">
                <h3 className="text-lg font-semibold text-yellow-900 mb-3">
                  {locale === "fi" ? "Tekniset vaatimukset" : "Technical Requirements"}
                </h3>
                <ul className="space-y-2 text-yellow-800">
                  <li className="flex items-start">
                    <svg className="flex-shrink-0 h-5 w-5 text-yellow-600 mt-0.5 mr-3" fill="currentColor" viewBox="0 0 20 20">
                      <path fillRule="evenodd" d="M16.707 5.293a1 1 0 010 1.414l-8 8a1 1 0 01-1.414 0l-4-4a1 1 0 011.414-1.414L8 12.586l7.293-7.293a1 1 0 011.414 0z" clipRule="evenodd" />
                    </svg>
                    <span>{locale === "fi" ? "Moderni web-selain (Chrome, Firefox, Safari, Edge)" : "Modern web browser (Chrome, Firefox, Safari, Edge)"}</span>
                  </li>
                  <li className="flex items-start">
                    <svg className="flex-shrink-0 h-5 w-5 text-yellow-600 mt-0.5 mr-3" fill="currentColor" viewBox="0 0 20 20">
                      <path fillRule="evenodd" d="M16.707 5.293a1 1 0 010 1.414l-8 8a1 1 0 01-1.414 0l-4-4a1 1 0 011.414-1.414L8 12.586l7.293-7.293a1 1 0 011.414 0z" clipRule="evenodd" />
                    </svg>
                    <span>{locale === "fi" ? "Vakaa internet-yhteys" : "Stable internet connection"}</span>
                  </li>
                  <li className="flex items-start">
                    <svg className="flex-shrink-0 h-5 w-5 text-yellow-600 mt-0.5 mr-3" fill="currentColor" viewBox="0 0 20 20">
                      <path fillRule="evenodd" d="M16.707 5.293a1 1 0 010 1.414l-8 8a1 1 0 01-1.414 0l-4-4a1 1 0 011.414-1.414L8 12.586l7.293-7.293a1 1 0 011.414 0z" clipRule="evenodd" />
                    </svg>
                    <span>{locale === "fi" ? "Mobiililaitteet tuettu" : "Mobile devices supported"}</span>
                  </li>
                </ul>
              </div>
            </section>
