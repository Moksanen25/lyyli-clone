...
export const metadata: Metadata = {
  ...
  description: "Get help with billing, subscriptions, payment methods, and account management for your Lyyli.ai service.",
};
              ...
              <li>
                <div className="flex items-center">
                  ...
                  <span className="ml-4 text-sm font-medium text-gray-500">
                    {locale === "fi" ? "Laskutus ja tilaukset" : "Billing & Subscriptions"}
                  </span>
                </div>
              </li>
            </ol>
            ...
            <div className="mb-8">
              ...
              <div className="space-y-6">
                ...
                <div className="border border-gray-200 rounded-lg p-6">
                  ...
                  <div className="bg-gray-50 p-4 rounded-md">
                    ...
                    <ol className="list-decimal list-inside space-y-1 text-sm text-gray-700">
                      ...
                      <li>{locale === "fi" ? "Valitse 'Tilaus'" : "Select 'Subscription'"}</li>
                      <li>{locale === "fi" ? "Valitse haluamasi suunnitelma" : "Choose your desired plan"}</li>
                      <li>{locale === "fi" ? "Vahvista muutos" : "Confirm the change"}</li>
                    </ol>
                  </div>
                </div>
                ...
                <div className="border border-gray-200 rounded-lg p-6">
                  ...
                  <div className="bg-gray-50 p-4 rounded-md">
                    <h4 className="font-medium text-gray-900 mb-2">
                      {locale === "fi" ? "Tuetut maksutavat:" : "Supported payment methods:"}
                    </h4>
                    <ul className="space-y-1 text-sm text-gray-700">
                      <li className="flex items-center">
                        ...
                        {locale === "fi" ? "Visa, Mastercard, American Express" : "Visa, Mastercard, American Express"}
                      </li>
                      <li className="flex items-center">
                        <svg className="w-4 h-4 text-green-500 mr-2" fill="currentColor" viewBox="0 0 20 20">
                          <path fillRule="evenodd" d="M16.707 5.293a1 1 0 010 1.414l-8 8a1 1 0 01-1.414 0l-4-4a1 1 0 011.414-1.414L8 12.586l7.293-7.293a1 1 0 011.414 0z" clipRule="evenodd" />
                      ...
                      <li className="flex items-center">
                        ...
                        {locale === "fi" ? "Pankkisiirto (SEPA)" : "Bank Transfer (SEPA)"}
                      </li>
                    </ul>
                  </div>
                </div>
                ...
                <div className="border border-gray-200 rounded-lg p-6">
                  ...
                  <div className="bg-gray-50 p-4 rounded-md">
                    ...
                    <ul className="space-y-1 text-sm text-gray-700">
                      <li>• {locale === "fi" ? "Käyttörajojen ylitys" : "Usage overages"}</li>
                      <li>• {locale === "fi" ? "Lisäpalvelut" : "Add-on services"}</li>
                      <li>• {locale === "fi" ? "Verot ja maksut" : "Taxes and fees"}</li>
                      <li>• {locale === "fi" ? "Suunnitelman muutokset" : "Plan changes"}</li>
                    </ul>
                  </div>
                </div>
              </div>
              ...
              <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                <div className="bg-green-50 p-6 rounded-lg border border-green-200">
                  ...
                  <ul className="space-y-2 text-sm text-green-800">
                    <li>• {locale === "fi" ? "Laskutetaan kuukausittain" : "Billed monthly"}</li>
                    <li>• {locale === "fi" ? "Peruutus milloin tahansa" : "Cancel anytime"}</li>
                ...
                <div className="bg-blue-50 p-6 rounded-lg border border-blue-200">
                  ...
                  <ul className="space-y-2 text-sm text-blue-800">
                    <li>• {locale === "fi" ? "Laskutetaan vuosittain" : "Billed annually"}</li>
            ...
            <div className="mb-8">
              ...
              <div className="bg-gray-50 p-6 rounded-lg">
                <h3 className="text-lg font-semibold text-gray-900 mb-4">
                  {locale === "fi" ? "Laskujen lataaminen ja tulostus" : "Downloading and Printing Invoices"}
                </h3>
                <p className="text-gray-600 mb-4">
                  {locale === "fi"
                  ...
                  <div className="text-center">
                    <div className="w-12 h-12 bg-green-100 rounded-lg flex items-center justify-center mx-auto mb-2">
                      <svg className="w-6 h-6 text-green-600" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                        <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M17 17h2a2 2 0 002-2v-4a2 2 0 00-2-2H5a2 2 0 00-2 2v4a2 2 0 002 2h2m2 4h6a2 2 0 002-2v-4a2 2 0 00-2-2H9a2 2 0 00-2 2v4a2 2 0 002 2zm7-5h2a2 2 0 012 2v4a2 2 0 01-2 2h-2a2 2 0 01-2-2v-4a2 2 0 012-2z" />
                      </svg>
                    </div>
