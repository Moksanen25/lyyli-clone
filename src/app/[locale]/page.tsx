        ...
        <div className="grid md:grid-cols-2 lg:grid-cols-4 gap-8">
          <InteractiveCard>
            <div className="text-center p-6">
              ...
              <h3 className="text-xl font-playfair font-bold mb-2">{t["problems.missedCommunications.title"]}</h3>
          ...
          <InteractiveCard>
            <div className="text-center p-6">
              ...
              <h3 className="text-xl font-playfair font-bold mb-2">{t["problems.channelOverload.title"]}</h3>
          ...
          <InteractiveCard>
            <div className="text-center p-6">
              ...
              <h3 className="text-xl font-playfair font-bold mb-2">{t["problems.accountability.title"]}</h3>
          ...
          <InteractiveCard>
            <div className="text-center p-6">
              ...
              <h3 className="text-xl font-playfair font-bold mb-2">{t["problems.regulatory.title"]}</h3>
