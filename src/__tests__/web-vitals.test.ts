...
describe('Web Vitals', () => {
  describe('getRating', () => {
    it('should return good for values within budget', () => {
      ...
      expect(getRating(100, WEB_VITALS_BUDGETS.inp)).toBe('good');
    ...
    it('should return needs-improvement for values slightly over budget', () => {
      ...
      expect(getRating(300, WEB_VITALS_BUDGETS.inp)).toBe('needs-improvement');
    ...
    it('should return poor for values significantly over budget', () => {
      ...
      expect(getRating(500, WEB_VITALS_BUDGETS.inp)).toBe('poor');
  ...
  describe('WEB_VITALS_BUDGETS', () => {
    it('should have appropriate budget values', () => {
      ...
      expect(WEB_VITALS_BUDGETS.inp).toBe(200);
    ...
    it('should have realistic budget thresholds', () => {
      ...
      // INP should be under 200ms for good UX
      expect(WEB_VITALS_BUDGETS.inp).toBeLessThan(300);
